...
with open(os.path.join(os.environ["SENSEXAMP_ROOT"], "configs/cls_task/custom.json")) as fp:
...
ckpt_path = os.path.join(os.environ["SENSEXAMP_ROOT"], "weights/amp_cls/sensexamp_cls_balanced.ckpt")
