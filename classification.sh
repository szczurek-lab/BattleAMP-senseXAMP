...
python tools/convert_inputs.py --fasta_file "$input_fasta" --csv_file "$inputpath" --mode "cls" &&
...
python tools/convert_outputs.py --input_file "$input_fasta" --output_file "$outputpath" --mode "cls"
